...
//	}
	...
	private boolean canFilter(String gameName) {
		return !"FootballTeam".equals(gameName) && !"Pingpong".equals(gameName) && !"PingpongTeam".equals(gameName) && !"Badminton".equals(gameName) && !"BadmintonTeam".equals(gameName) && !"BasketballTeam".equals(gameName) && !"VolleyballTeam".equals(gameName);
	}
