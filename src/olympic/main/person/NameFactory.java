...
public class NameFactory {
     ...
     * 英文姓氏
     */
    static final String[] lastNameEn = {" Admirind",
            " Aerum",
            " Akvum",
            " Ambrofaltkhawsen",
            " Ameblo",
     ...
     * 中文名枚举
     */
    static final String[] firstNameInside = {
            "赵", "钱", "孙", "李", "周", "吴", "郑", "王",
            "冯", "陈", "楮", "卫", "蒋", "沈", "韩", "杨",
            "朱", "秦", "尤", "许", "何", "吕", "施", "张",
            "孔", "曹", "严", "华", "金", "魏", "陶", "姜",
     ...
     * 名字set
     */
    private HashSet<String> sites = new HashSet<>();
    /**
     * 国家队set
     */
    private HashSet<String> nationSites = new HashSet<>();
