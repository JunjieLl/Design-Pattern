...
//            System.out.println("裁判员代表" + refereeRepre()+"进场宣誓");
            System.out.println("运动员代表" + athleteRepre.getName()+"进场宣誓");
            athleteRepre.speech();
            System.out.println("裁判员代表" + coachRepre.getName()+"进场宣誓");
            coachRepre.speech();
...
//        System.out.println(HP()+"退场，落座");
        ...
        System.out.println("首先，由本届奥运会组委会主席" + OOCP.getName()+"讲话");
        OOCP.speech();
        System.out.println(OOCP.getName()+"退场，落座");
        System.out.println("再由国际奥委会主席" + IOCP.getName()+"讲话");
        IOCP.speech();
        System.out.println(IOCP.getName()+"退场，落座");
        System.out.println("最后由东道主国家元首" + HP.getName()+"宣布奥运会"+state);
        HP.speech();
        System.out.println(HP.getName()+"退场，落座");
